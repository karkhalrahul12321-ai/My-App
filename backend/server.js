// =====================================
// Trading Helper Backend (FINAL STABLE + FALLBACK TOKENS)
...
const FALLBACK_TOKENS = {
  nifty: {
    ...
    token: "113063",
    expiry: null, // चाहो तो "2025-12-26" जैसा सही date डाल सकते हो
  },
  sensex: {
...
async function getAutoFutureLTP(market) {
  ...
  try {
    ...
    // कुछ responses में data.data.ltp होता है, कुछ में array – दोनों handle करें
    const ltpVal =
