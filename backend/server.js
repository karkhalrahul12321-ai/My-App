// =====================================
// Trading Helper Backend (FINAL CLEAN)
...
// NOTE: अभी सिर्फ "/" रूट, wildcard सबसे आख़िर में होगा
app.get("/", (req, res) => {
...
async function smartApiLogin(tradingPassword) {
  ...
  try {
    ...
    // debug log (Render logs में दिखेगा)
    console.log("SMARTAPI LOGIN RAW RESPONSE:", JSON.stringify(data));
...
app.post("/api/login", async (req, res) => {
  ...
  if (!r.ok) {
    return res.json({
      ...
      raw: r.raw || null // extra info ताकि जरूरत हो तो देख सकें
    });
  }
...
// =====================================
// SPA FALLBACK – अब सबसे आख़िर में
// =====================================
app.get("*", (req, res) => {
  res.sendFile(path.join(frontendPath, "index.html"));
});
