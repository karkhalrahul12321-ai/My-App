...
const SMART_NIFTY_SYMBOL = process.env.SMART_NIFTY_SYMBOL || "NIFTY30JAN25FUT";
const SMART_SENSEX_SYMBOL = process.env.SMART_SENSEX_SYMBOL || "SENSEX30JAN25FUT";
const SMART_NATGAS_SYMBOL = process.env.SMART_NATGAS_SYMBOL || "NATURALGAS27JAN25FUT";
...
const MARKET_CONFIG = {
  nifty: {
    ...
    exchange: "NFO",
    futSymbol: SMART_NIFTY_SYMBOL,
    futToken: SMART_NIFTY_TOKEN || ""
  },
  sensex: {
    name: "Sensex",
    strikeStep: 100,
    ...
    exchange: "BFO",
    futSymbol: SMART_SENSEX_SYMBOL,
    futToken: SMART_SENSEX_TOKEN || ""
  },
  "natural gas": {
    name: "Natural Gas",
    strikeStep: 5,
    ...
    exchange: "MCX",
    futSymbol: SMART_NATGAS_SYMBOL,
    futToken: SMART_NATGAS_TOKEN || ""
  }
};
