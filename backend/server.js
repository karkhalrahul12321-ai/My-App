...
// FUTURES TOKEN / SYMBOL (OPTIONAL OVERRIDE)
// ये अगर नहीं दोगे तो नीचे default symbols यूज़ होंगे
...
// FUTURE symbols + tokens यहाँ map कर रहे हैं
// =====================================
const MARKET_CONFIG = {
  nifty: {
    name: "Nifty",
  ...
  sensex: {
    ...
    exchange: "BFO", // BSE FUTURES (अगर अलग हो तो बाद में adjust)
