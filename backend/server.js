// =====================================
// Trading Helper Backend
// SmartAPI Login + Auto Futures + HTTP LTP
// Trend + Strike Engine + Premium Engine v1
// Markets: Nifty, Sensex, Natural Gas
// (No WebSocket – safe & stable build)
// =====================================
...
const FUTURE_RULES = {
  nifty: {
    ...
    expiryDay: 4, // Thursday – weekly / monthly
  },
  sensex: {
    searchSymbol: "SENSEX",
    exchange: "BFO",
...
// =====================================
// FALLBACK TOKENS (from CSV – Dec 2025)
// =====================================
...
// =====================================
// SMARTAPI searchScrip – auto token
// =====================================
...
// =====================================
// PREMIUM ENGINE v1 (no extra API calls)
// =====================================
...
function premiumEngine(input, trend, strikes) {
  ...
  const spot = pnum(input.spot);
  const ema20 = pnum(input.ema20);
  const ema50 = pnum(input.ema50);
  const rsi = pnum(input.rsi);
  const vwap = pnum(inpu
