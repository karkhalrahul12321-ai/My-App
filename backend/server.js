...
/* -------------------------------------------------------------
   EXPORT (kept for tests / modular usage)
-------------------------------------------------------------- */
module.exports = {
  app,
  session,
...
/* SAFE FALLBACK ROOT — keep original frontend root intact;
   this route provides a lightweight text status (won't break frontend) */
