/* ============================================================
   FINAL BACKEND — VERSION C
   SmartAPI Login + Auto Token + Live LTP + Trend + Strikes
   Cleaned + Render Compatible
============================================================ */
...
function computeTrend(input) {
  ...
  if (score >= 80) {
    main = "UPTREND"; strength = "STRONG"; bias = "CE";
  } else if (score >= 60) {
    main = "UPTREND"; strength = "MODERATE"; bias = "CE";
  } else if (score <= 20) {
    main = "DOWNTREND"; strength = "STRONG"; bias = "PE";
  } else if (score <= 40) {
    main = "DOWNTREND"; strength = "MODERATE"; bias = "PE";
  }
