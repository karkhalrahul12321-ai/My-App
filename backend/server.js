// =====================================
// Trading Helper Backend (FINAL + PREMIUM ENGINE)
// SmartAPI Login + Auto Future Token + Live FUT LTP + Trend + Strikes + Premium Suggestions
...
// =====================================
// FALLBACK TOKENS (backup, अगर search न मिले)
// =====================================
...
async function getAutoFutureLTP(market) {
  ...
  try {
    // NOTE: SmartAPI v2 का quote endpoint – यहाँ हम exchange + tradingsymbol + symboltoken से LTP निकाल रहे हैं
    const resp = await fetch(
