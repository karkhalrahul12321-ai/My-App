// =====================================
// Trading Helper Backend (FINAL STABLE)
// SmartAPI Login + Auto Future Token + HTTP LTP + Trend + Strikes + Premium Engine
// Part 1/4
// =====================================
...
// =====================================
// MANUAL FORCE AUTO TOKEN FETCH API
// =====================================
...
function scaleDistancesByExpiry(expiryDays, baseDistances, step) {
  ...
  // expiry जितनी पास → उतनी छोटी दूरी
...
function buildStrikes(input, trend) {
  ...
  function makeOption(strike, type, diff) {
    ...
    const base = Math.max(5, steps * 5); // approx premium base
    return {
      type,
      strike,
